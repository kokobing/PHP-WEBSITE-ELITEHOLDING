...
function mailsend() {
						...
						$.post('ajax_sendmailfree.php',{name:$("#name").val(),company:$("#company").val(),phone:$("#phone").val(),email:$("#email").val(),comments:$("#comments").val()},function(data) {
    ...
    <div id="main" class="clearfix">
      ...
      <div id="content">
        <div id="content-inner" class="inner column">
              ...
              <div class="breadcrumb"><a href="/">Home</a> » Free Design CD</div>

				              
                              <h1 class="title">Free Design CD</h1>
