<?php require "../inc/cn_design_core.php" ?>
...
<!-- header end -->
    ...
    <div id="main" class="clearfix">
      ...
      <div id="content">
        <div id="content-inner" class="inner column">
              ...
              <div class="breadcrumb"><a href="/">Home</a> » <?php $str=getonenewsdir2(3);echo $str;?></div>
  ...
  <div class="node-inner">
    ...
    <div class="content">
<?php for($i=0;$i<sizeof($designnews);$i++){?>
<h3><a href="/design/designinfo?nid=<?=$designnews[$i][id_newsinfo]?>"><?=$designnews[$i][title]?></a></h3>
<p><?=$designnews[$i][intro]?></p>
<p><a href="/design/designinfo?nid=<?=$designnews[$i][id_newsinfo]?>">Learn more about Premier Die Casting Engineering</a></p>
<p>&nbsp;</p>
<hr />
<p>&nbsp;</p>
<?php }?>
