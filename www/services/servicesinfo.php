<?php require "../inc/cn_servicesinfo_core.php" ?>
    ...
    <div id="main" class="clearfix">
      ...
      <div id="content">
        <div id="content-inner" class="inner column">
              ...
              <div class="breadcrumb"><a href="/">Home</a> » <a href="/services/services.php"><?php $str=getonenewsdir2(2);echo $str;?></a> » <?=$onenews[title]?></div>
