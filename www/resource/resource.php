<?php require "../inc/cn_resource_core.php" ?>
    ...
    <div id="main" class="clearfix">
      ...
      <div id="content">
        <div id="content-inner" class="inner column">
              ...
              <div class="breadcrumb"><a href="/">Home</a> » <?php $str=getonenewsdir2(4);echo $str;?></div>
...
<h3><a href="/resource/resourceinfo?nid=<?=$resourcenews[$i][id_newsinfo]?>"><?=$resourcenews[$i][title]?></a></h3>
<p><?=$resourcenews[$i][intro]?></p>
<p><a href="/resource/resourceinfo?nid=<?=$resourcenews[$i][id_newsinfo]?>">View More</a></p>
<p>&nbsp;</p>
<hr />
<p>&nbsp;</p>
<?php }?>
